...
namespace AustPICWeb.Middleware
{
    public class AntiXssMiddleware
    {
        ...
        {
            Console.WriteLine("Executing AntiXssMiddleware...");
            ...
            try
            {
                if (!(context.Request.Method == "POST" && context.Request.ContentType != null && context.Request.ContentType.ToLower().Contains("multipart/form-data")))
                {
                    ...
                    // Sanitize the content using the HtmlSanitizer library
                    ...
                    // Check if any characters were removed during sanitization
            ...
            finally
            {
                ...
                // Set the request body back to its original value
                context.Request.Body = originalBody;
            }

            Console.WriteLine("AntiXssMiddleware execution complete.");
        }
